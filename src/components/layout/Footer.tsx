...
function MaskGroup({ className, property1 = "Default" }: MaskGroupProps) {
  ...
  return (
    <div className={className || "h-[232px] relative w-[440px]"}>
      ...
      />
      <div
        className={`absolute mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[399.658px_232.073px] ${isVariant3
      ...
      <div
        className={`absolute mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[399.658px_232.073px] mix-blend-color-dodge ${isVariant3
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-[53px] pt-10 lg:pt-[130px] pb-10 lg:pb-[69px]">
        ...
        <div className="hidden lg:grid lg:grid-cols-[440px_1fr_1fr_1fr] lg:grid-rows-[auto_auto] gap-x-[34px] gap-y-[128px] items-start">
          ...
          <div className="col-start-2 row-start-1 flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>London</p>
            <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70 max-w-[268px]" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, 26 Main Road Sundridge, TN14 6EP, England, United Kingdom.</p>
          </div>
          <div className="col-start-3 row-start-1 flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>Dubai</p>
            <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70 max-w-[268px]" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, Jumeirah Business Center 5 Cluster W, Jumeirah Lakes Towers, Dubai, United Arab Emirates</p>
          </div>
          <div className="col-start-4 row-start-1 flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>London</p>
            <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70 max-w-[211px]" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, Nirmal, Anand Nagar, Suncity Road, Pune, Maharashtra, 411041, India</p>
          </div>
          <div className="col-start-2 row-start-2 flex flex-col gap-4">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3] text-[#e9f4f9] text-[16px]" style={{ fontVariationSettings: "'wdth' 100" }}>Solutions</p>
            <div className="flex flex-col gap-[10px]">
              {["Core Banking CB7", "Digital Banking N7", "Open Banking", "Loan Origination System", "Loan Management System", "Digital Transformation"].map((item) => <NavLink key={item} label={item} />)}
            </div>
          </div>
          <div className="col-start-3 row-start-2 flex flex-col gap-4">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3] text-[#e9f4f9] text-[16px]" style={{ fontVariationSettings: "'wdth' 100" }}>N7 Banking</p>
            <div className="flex flex-col gap-[10px]">
              {["About Us", "Solutions", "Contact", "Company", "Careers", "Insights", "Core Team", "Brand Center"].map((item) => <NavLink key={item} label={item} />)}
            </div>
          </div>
          <div className="col-start-4 row-start-2 flex flex-col gap-4">
            <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3] text-[#e9f4f9] text-[16px]" style={{ fontVariationSettings: "'wdth' 100" }}>Our Socials</p>
            <div className="flex flex-col gap-[10px]">
              {["LinkedIn", "X"].map((item) => <NavLink key={item} label={item} />)}
            </div>
          </div>
        </div>
        ...
        <div className="lg:hidden flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
              <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>London</p>
              <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, 26 Main Road Sundridge, TN14 6EP, England, United Kingdom.</p>
            </div>
            <div className="flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
              <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>Dubai</p>
              <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, Jumeirah Business Center 5 Cluster W, Jumeirah Lakes Towers, Dubai, United Arab Emirates</p>
            </div>
            <div className="flex flex-col gap-4 text-[#e9f4f9] text-[16px]">
              <p className="font-['Archivo:Medium',sans-serif] font-medium leading-[1.3]" style={{ fontVariationSettings: "'wdth' 100" }}>London</p>
              <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[1.3] opacity-70" style={{ fontVariationSettings: "'wdth' 100" }}>Linktia Infosystems Ltd – CB7, Nirmal, Anand Nagar, Suncity Road, Pune, Maharashtra, 411041, India</p>
            </div>
          </div>
