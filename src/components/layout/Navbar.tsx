  ...
  return (
    <>
      ...
      <div className="md:hidden sticky z-50 backdrop-blur-[7.5px] bg-[rgba(47,47,47,0.7)] w-[97%] mx-auto content-stretch flex justify-between items-center px-4 py-3 top-3">
        <p className="[word-break:break-word] font-['Archivo:Medium',sans-serif] font-medium leading-[1.2] relative shrink-0 text-[#e9f4f9] text-[20px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          N7
        </p>
        <div className="flex items-center gap-6">
          ...
          >
            <svg width="40" height="40" viewBox="0 0 70 70" fill="none" xmlns="http://w3.org">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden sticky z-40 backdrop-blur-[7.5px] bg-[rgba(47,47,47,0.9)] w-full px-4 py-4 top-16 space-y-3">
          <div className="py-2 px-3 rounded-[6px] hover:bg-[rgba(233,244,249,0.1)] cursor-pointer">
            <p className="[word-break:break-word] font-['Chivo_Mono_Medium:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#e9f4f9] text-[12px] uppercase">Solutions</p>
          </div>
          <div className="py-2 px-3 rounded-[6px] hover:bg-[rgba(233,244,249,0.1)] cursor-pointer">
            <p className="[word-break:break-word] font-['Chivo_Mono_Medium:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#e9f4f9] text-[12px] uppercase">Resources</p>
          </div>
          <div className="py-2 px-3 rounded-[6px] hover:bg-[rgba(233,244,249,0.1)] cursor-pointer">
            <p className="[word-break:break-word] font-['Chivo_Mono_Medium:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#e9f4f9] text-[12px] uppercase">About Us</p>
          </div>
        </div>
      )}
    </>
