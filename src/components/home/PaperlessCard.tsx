    ...
    <section className="w-full px-4 py-16 sm:px-6 md:px-10 lg:px-16 xl:px-20">
      <div
        className="
          ...
          max-w-[1280px] mx-auto min-h-[520px] md:min-h-[420px]
          px-6 py-10 md:px-10 lg:px-[65px]
        "
        style={{
          background:
      ...
      >
        ...
        <div
          className="
            absolute right-[-40px] md:right-[-60px]
          ...
          <div className="relative">
            <p
              className="
                ...
                font-medium leading-none text-transparent whitespace-nowrap
                opacity-50
                text-[180px]
                sm:text-[240px]
                md:text-[320px]
        ...
        <div
          className="
            ...
            h-full min-h-[520px] md:min-h-[420px]
          "
        >
          {/* Left Content */}
          <div className="max-w-[620px]">
            ...
            <p
              className="
                break-words flex-1 basis-0
                font-medium leading-[1.3]
                min-w-0 opacity-70
                text-[16px] mt-8 text-start
                text-[#e9f4f9]
              "
              style={{
