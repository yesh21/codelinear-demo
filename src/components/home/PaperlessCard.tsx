  ...
  return (
    <div className="bg-[#000d12] h-[681px] overflow-clip relative shrink-0 w-[1440px]">
      <div className="-translate-y-1/2 absolute h-[427px] left-[81px] overflow-clip rounded-[27px] top-1/2 w-[1279px]" style={{ backgroundImage: "linear-gradient(115.899deg, rgb(3, 30, 42) 12.22%, rgb(0, 13, 18) 59.256%)" }}>
        <p className="-translate-x-full [word-break:break-word] absolute font-['Archivo:Medium',sans-serif] font-medium leading-[1.2] left-[1364.56px] opacity-50 text-[572.632px] text-[transparent] text-right top-[-160.72px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          CB7
        </p>
