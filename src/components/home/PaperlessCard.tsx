...
export function PaperlessCard({ backgroundText = 'CB7' }: PaperlessCardProps) {
  return (
    <section className="w-full px-4 py-16 sm:px-6 md:px-10 lg:px-16 xl:px-20">
      <div
        className="
          relative overflow-hidden rounded-[20px] md:rounded-[24px] lg:rounded-[27px] 
          max-w-[1280px] mx-auto min-h-[520px] md:min-h-[420px] px-6 py-10 md:px-10 lg:px-[65px]
        "
        style={{
          background:
      ...
      >
        {/* Background CB7 */}
        <div
          className="absolute right-[-40px] md:right-[-60px] top-[-20px] 
          md:top-[-80px] pointer-events-none select-none opacity-50"
        >
          <p
            className="
              font-['Archivo:Medium',sans-serif] font-medium leading-none text-transparent
              whitespace-nowrap text-[180px] sm:text-[240px] md:text-[320px] lg:text-[420px] xl:text-[572px]
            "
            style={{
        ...
        <div
          ...
          justify-center gap-10 h-full min-h-[520px] md:min-h-[420px]"
        >
          {/* Left Content */}
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-4 mx-auto lg:w-auto">
