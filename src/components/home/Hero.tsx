        ...
        <div className="absolute inset-[-25.07%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 598.873 598.873">
            <g filter="url(#filter0_f_1_1621)" opacity="0.5">
              <circle cx="299.437" cy="299.437" fill="url(#paint0_linear_1_1621)" r="199.437" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="598.873" id="filter0_f_1_1621" width="598.873" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_1621" stdDeviation="50" />
              </filter>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1621" x1="195.436" x2="590.687" y1="-320.62" y2="-226.218">
      ...
      <div className="relative z-10 mt-10 h-[301px] w-[562px] origin-top scale-[0.58] sm:scale-[0.75] md:scale-90 lg:absolute lg:left-[calc(58.33%-22px)] lg:top-1/2 lg:mt-0 lg:w-[562px] lg:-translate-y-1/2 lg:scale-100">
        ...
        <div className="-translate-y-1/2 absolute z-20 backdrop-blur-[6px] bg-[rgba(255,255,255,0.4)] h-[177px] left-[353px] overflow-clip rounded-[12px] shadow-[0px_0px_27.571px_8.92px_rgba(0,0,0,0.25)] top-[calc(50%-39px)] w-[208px]">
          ...
          <div className="-translate-y-1/2 absolute bg-[rgba(255,255,255,0.7)] h-[168px] left-[5px] overflow-clip rounded-[11px] top-1/2 w-[199px]">
            ...
            <p className="absolute font-['Inter:Bold',sans-serif] font-bold left-[39.68px] text-[8.609px] top-[22.62px] text-[#0d0d0c] leading-[normal]">Toni Kross</p>
            <p className="absolute font-['Inter:Regular',sans-serif] font-normal left-[39.68px] opacity-60 text-[6.457px] top-[37.15px] text-[#0d0d0c] leading-[normal]">Good Morning</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[19.37px] left-[7.4px] text-[#081e69] text-[15.065px] top-[75.89px]">$42,295.00 USD</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[11.837px] left-[31.4px] text-[#0d0d0c] text-[7.533px] text-center top-[151.21px] whitespace-nowrap -translate-x-1/2">Fund Transfer</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[11.837px] left-[107.03px] text-[#0d0d0c] text-[7.533px] text-center top-[151.21px] whitespace-nowrap -translate-x-1/2">Add Money</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[11.837px] left-[175.12px] text-[#0d0d0c] text-[7.533px] text-center top-[151.21px] whitespace-nowrap -translate-x-1/2">More</p>
          </div>
          ...
          <div className="absolute h-[174.328px] left-[9.71px] top-[181.96px] w-[198.54px]">
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.065px] left-0 text-[#0f0f0f] text-[10.761px] top-0 whitespace-nowrap">Recent activity</p>
            ...
            <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[2.69px] px-[6.457px] py-[1.076px] rounded-[8.609px] top-[25.83px]">
              <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[10.761px] text-[#0d0d0c] text-[6.457px] text-center whitespace-nowrap">This Day</p>
            </div>
            <div className="absolute bg-[#081e69] flex items-center justify-center left-[51.65px] px-[6.457px] py-[1.076px] rounded-[8.609px] top-[25.83px]">
              <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[10.761px] text-[6.457px] text-center text-white whitespace-nowrap">This Week</p>
            </div>
            <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[105.46px] px-[6.457px] py-[1.076px] rounded-[8.609px] top-[25.83px]">
              <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[10.761px] text-[#0d0d0c] text-[6.457px] text-center whitespace-nowrap">This Month</p>
            </div>
            <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[161.41px] px-[6.457px] py-[1.076px] rounded-[8.609px] top-[25.83px]">
              <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[10.761px] text-[#0d0d0c] text-[6.457px] text-center whitespace-nowrap">6 Month</p>
            </div>

            {/* Transaction row 1: To Jin */}
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] left-[37.13px] text-[#0b0b0b] text-[8.609px] top-[49.5px] whitespace-nowrap">To Jin</p>
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[12.913px] left-[66.18px] opacity-60 text-[#0b0b0b] text-[8.609px] top-[49.5px] whitespace-nowrap">Work</p>
            <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[10.761px] left-[37.13px] opacity-80 text-[#0b0b0b] text-[6.457px] top-[64.57px] whitespace-nowrap">12 jun 2022</p>
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] right-0 text-[#0b0b0b] text-[8.609px] text-right top-[55.96px] whitespace-nowrap">-$59</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] left-[37.13px] text-[#0b0b0b] text-[8.609px] top-[94.7px] whitespace-nowrap">From Google</p>
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[12.913px] left-[95.23px] opacity-60 text-[#0b0b0b] text-[8.609px] top-[94.7px] whitespace-nowrap">Salary</p>
            <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[10.761px] left-[37.13px] opacity-80 text-[#0b0b0b] text-[6.457px] top-[109.76px] whitespace-nowrap">10 jun 2022</p>
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] right-0 text-[#0b0b0b] text-[8.609px] text-right top-[101.15px] whitespace-nowrap">+$859</p>
            ...
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] left-[37.13px] text-[#0b0b0b] text-[8.609px] top-[139.89px] whitespace-nowrap">To David</p>
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[12.913px] left-[78.56px] opacity-60 text-[#0b0b0b] text-[8.609px] top-[139.89px] whitespace-nowrap">Work</p>
            <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[10.761px] left-[37.13px] opacity-80 text-[#0b0b0b] text-[6.457px] top-[154.96px] whitespace-nowrap">7 jun 2022</p>
            <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] right-0 text-[#0b0b0b] text-[8.609px] text-right top-[146.35px] whitespace-nowrap">-$479</p>
          ...
          <div className="absolute h-[43.044px] left-[-0.52px] top-[405.79px] w-[209.839px]">
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_83.84%_15.87%_6.15%] leading-[11.837px] text-[#1b1b1b] text-[7.53px] whitespace-nowrap">Home</p>
            {/* Card */}
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_62.19%_15.87%_29.23%] leading-[11.837px] text-[#1b1b1b] text-[7.53px] whitespace-nowrap">Card</p>
            {/* Transaction */}
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_29.44%_15.87%_51.03%] leading-[11.837px] text-[#1b1b1b] text-[7.53px] whitespace-nowrap">Transaction</p>
            {/* Profile */}
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_5.93%_15.87%_83.59%] leading-[11.837px] text-[#1b1b1b] text-[7.53px] whitespace-nowrap">Profile</p>
            {/* Active indicator */}
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] left-[calc(16.67%+12.16px)] text-[#0b0b0b] text-[8.609px] top-[367.05px] whitespace-nowrap">From Google</p>
          <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[12.913px] left-[calc(50%+0.94px)] opacity-60 text-[#0b0b0b] text-[8.609px] top-[367.05px] whitespace-nowrap">Bonus</p>
          <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[10.761px] left-[calc(16.67%+12.16px)] opacity-80 text-[#0b0b0b] text-[6.457px] top-[382.12px] whitespace-nowrap">10 jun 2022</p>
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[12.913px] right-0 text-[#0b0b0b] text-[8.609px] text-right top-[373.51px] whitespace-nowrap">+$859</p>
        </div>
        ...
        <div className="absolute z-20 backdrop-blur-[8.096px] bg-[rgba(255,255,255,0.4)] h-[117px] left-[-28px] overflow-clip rounded-[12px] top-[150px] w-[254px]">
          <div className="-translate-y-1/2 absolute bg-[rgba(255,255,255,0.7)] h-[109px] left-[4px] overflow-clip rounded-[11px] top-1/2 w-[246px]">
            <div className="-translate-x-1/2 absolute h-[204.533px] left-1/2 top-[10px] w-[232.94px]">
              ...
              <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[3.16px] px-[7.575px] py-[1.263px] rounded-[10.1px] top-[30.3px]">
                <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[12.625px] text-[#0d0d0c] text-[7.575px] text-center whitespace-nowrap">This Day</p>
              </div>
              <div className="absolute bg-[#081e69] flex items-center justify-center left-[60.6px] px-[7.575px] py-[1.263px] rounded-[10.1px] top-[30.3px]">
                <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[12.625px] text-[7.575px] text-center text-white whitespace-nowrap">This Week</p>
              </div>
              <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[123.73px] px-[7.575px] py-[1.263px] rounded-[10.1px] top-[30.3px]">
                <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[12.625px] text-[#0d0d0c] text-[7.575px] text-center whitespace-nowrap">This Month</p>
              </div>
              <div className="absolute bg-[#f8f8f8] flex items-center justify-center left-[189.38px] px-[7.575px] py-[1.263px] rounded-[10.1px] top-[30.3px]">
                <p className="font-['Gilroy-Medium:☞',sans-serif] leading-[12.625px] text-[#0d0d0c] text-[7.575px] text-center whitespace-nowrap">6 Month</p>
              </div>
              ...
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] left-[43.56px] text-[#0b0b0b] text-[10.1px] top-[58.08px] whitespace-nowrap">To Jin</p>
              <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[15.151px] left-[77.65px] opacity-60 text-[#0b0b0b] text-[10.1px] top-[58.08px] whitespace-nowrap">Work</p>
              <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[12.625px] left-[43.56px] opacity-80 text-[#0b0b0b] text-[7.575px] top-[75.75px] whitespace-nowrap">12 jun 2022</p>
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] right-0 text-[#0b0b0b] text-[10.1px] text-right top-[65.65px] whitespace-nowrap">-$59</p>
              ...
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] left-[43.56px] text-[#0b0b0b] text-[10.1px] top-[111.1px] whitespace-nowrap">From Google</p>
              <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[15.151px] left-[111.74px] opacity-60 text-[#0b0b0b] text-[10.1px] top-[111.1px] whitespace-nowrap">Salary</p>
              <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[12.625px] left-[43.56px] opacity-80 text-[#0b0b0b] text-[7.575px] top-[128.78px] whitespace-nowrap">10 jun 2022</p>
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] right-0 text-[#0b0b0b] text-[10.1px] text-right top-[118.68px] whitespace-nowrap">+$859</p>
              ...
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] left-[43.56px] text-[#0b0b0b] text-[10.1px] top-[164.13px] whitespace-nowrap">To David</p>
              <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[15.151px] left-[92.17px] opacity-60 text-[#0b0b0b] text-[10.1px] top-[164.13px] whitespace-nowrap">Work</p>
              <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[12.625px] left-[43.56px] opacity-80 text-[#0b0b0b] text-[7.575px] top-[181.81px] whitespace-nowrap">7 jun 2022</p>
              <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.151px] right-0 text-[#0b0b0b] text-[10.1px] text-right top-[171.71px] whitespace-nowrap">-$479</p>
          ...
          <div className="absolute h-[54.874px] left-[-6.97px] top-[298.78px] w-[267.509px]">
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_83.75%_14.59%_6.15%] leading-[15.09px] text-[#1b1b1b] text-[9.6px] whitespace-nowrap">Home</p>
            <div className="absolute overflow-clip inset-[16.25%_63.33%_53.75%_30.51%]">
              <div className="absolute inset-[9.37%_5.21%]">
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_62.17%_14.59%_29.23%] leading-[15.09px] text-[#1b1b1b] text-[9.6px] whitespace-nowrap">Card</p>
            <div className="absolute overflow-clip inset-[16.25%_36.41%_53.75%_57.44%]">
              <div className="absolute inset-[17.71%]">
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_29.54%_14.59%_51.03%] leading-[15.09px] text-[#1b1b1b] text-[9.6px] whitespace-nowrap">Transaction</p>
            <div className="absolute overflow-clip inset-[16.25%_8.21%_53.75%_85.64%]">
            ...
            <p className="absolute font-['Gilroy-Medium:☞',sans-serif] inset-[56.25%_6.32%_14.59%_83.59%] leading-[15.09px] text-[#1b1b1b] text-[9.6px] whitespace-nowrap">Profile</p>
            <div className="absolute bg-[#081e69] inset-[0_84.1%_98.13%_6.41%] rounded-[24px]" />
          </div>
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.09px] left-[39.99px] text-[#0d0d0c] text-[9.603px] text-center top-[-18.12px] whitespace-nowrap -translate-x-1/2">Fund Transfer</p>
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.09px] left-[calc(33.33%+51.84px)] text-[#0d0d0c] text-[9.603px] text-center top-[-18.12px] whitespace-nowrap -translate-x-1/2">Add Money</p>
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[15.09px] left-[calc(83.33%+11.67px)] text-[#0d0d0c] text-[9.603px] text-center top-[-18.12px] whitespace-nowrap -translate-x-1/2">More</p>
          ...
          <p className="absolute font-['Inter:Bold',sans-serif] font-bold left-[calc(16.67%+8.31px)] text-[10.975px] top-[-182.05px] text-[#0d0d0c] leading-[normal]">Toni Kross</p>
          <p className="absolute font-['Inter:Regular',sans-serif] font-normal left-[calc(16.67%+8.31px)] opacity-60 text-[8.231px] top-[-163.53px] text-[#0d0d0c] leading-[normal]">Good Morning</p>
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[24.693px] left-[9.49px] text-[#081e69] text-[19.206px] top-[-114.14px]">$42,295.00 USD</p>
          ...
          <p className="absolute font-['Gilroy-Bold:☞',sans-serif] leading-[16.462px] left-[calc(16.67%+11.06px)] text-[#0b0b0b] text-[10.975px] top-[249.39px] whitespace-nowrap">From Google</p>
          <p className="absolute font-['Gilroy-Medium:☞',sans-serif] leading-[16.462px] left-[calc(50%+0.47px)] opacity-60 text-[#0b0b0b] text-[10.975px] top-[249.39px] whitespace-nowrap">Bonus</p>
          <p className="absolute font-['Gilroy-Regular:☞',sans-serif] leading-[13.718px] left-[calc(16.67%+11.06px)] opacity-80 text-[#0b0b0b] text-[8.231px] top-[268.6px] whitespace-nowrap">10 jun 2022</p>
